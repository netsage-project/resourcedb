...
INSERT INTO `discipline` VALUES (35,'BIO.Environmental','Populations, species, ecosystems, ecological studies'),(36,'BIO.Genomics and Bioinformatics','Genomes, protein sequences, *omics, statistics, computational biology'),(37,'BIO.Medical','Cells, individual genes, cancer, medical research, brain research and modelling, neuroscience, biomedical databases'),(38,'BIO.General','Other, unknown, or multiple types of Biology-related research'),(39,'CS.Intelligent Systems','Includes computer vision and AI'),(40,'CS.Network Testing and Monitoring','E.g., PerfSonar nodes'),(41,'CS.General','Other, unknown, or multiple types of Computer Science and networking research'),(42,'GEO.Atmospheric','Observation and modeling of atmospheric and geospace phenomena and weather, ionosphere, auroras, flares and space weather, etc. (see also Climate)'),(43,'GEO.Climate','Climate change and its effects, including atmosphere and ocean modeling, multi-disciplinary studies'),(44,'GEO.Earth','Geology, hydrology, tectonics, etc., Geodesy except primarily VLBI.'),(45,'GEO.Ocean','The oceans and their contents (see also Climate)'),(46,'GEO.General','Other, unknown, or multiple types of Earth Sciences; also general or multi-target remote sensing by satellites'),(47,'MPS.Astronomy','Observational and theoretical astronony and astrophysics including cosmic rays, VLBA, VLBI for geodetic/astrometric purposes'),(48,'MPS.Chemistry','Applied or theoretical chemisty'),(49,'MPS.Materials','R&D related to materials including nanomaterials'),(50,'MPS.Math','Mathematics and Statistics'),(51,'MPS.Physics','Physics and energy research, other than high energy particle physics'),(52,'MPS.Physics.High Energy','Theoretical and experimental sub-atomic particle physics; gridFTP and similar used mainly by the HEP community'),(53,'SBE.Psychology and Cognitive','Research in cognition, language, social behavior, etc'),(54,'SBE.Social and Economics','Economics, Political Science, and Sociology '),(55,'SBE.General','Other, unknown or multiple Social, Behavioral, and Economics areas'),(56,'Multiple Science Facility','A resource used by multiple sciences; most often a supercomputer or supercomputer center'),(57,'Unknown','Nothing is known about the science discipline'),(58,'ENG.General','Various types of Engineering'),(59,'non-science','eg, Microsoft updates, CentOS mirror or archive, rocket and satellite systems, etc.');
...
INSERT INTO `version` VALUES (2,'0.1.1');
